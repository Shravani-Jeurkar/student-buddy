...
use function PHPSTORM_META\type;
    ...
    if(isset($_POST['register']))
    {
        ...
        $img_r = uploadUserImage($_FILES['profile']);
        ...
        $query = "INSERT INTO `user_cred`(`name`, `email`, `phonenum`, `profile`, `intro`, `password`, `token`)
            VALUES (?,?,?,?,?,?,?)";
        
        $values = [$data['name'], $data['email'], $data['phonenum'], $img_r, $data['intro'], $enc_pass, $token];
